...
static_start = 0;
static_samples = 0;
num_samples_qs = ceil(1 / time_interval);
...
scale_matrix = diag([theta_pr_gyro(1), theta_pr_gyro(5), theta_pr_gyro(9)]);

omega_hat = [omega_x_hat; omega_y_hat; omega_z_hat];
calib_omega = misal_matrix * scale_matrix * omega_hat;
...
gyro_calib_result = struct(...
    ...
    'residuals', residuals, ...
    'QS_time_interval_calib_info_matrix', QS_time_interval_calib_info_matrix, ...
